...
This repository contains evolving content used as introductory teaching material for the Rubyist Historian ebook project by Jason A. Heppler.  The latest releases of the book can be found at http://www.jasonheppler.org.
